...
const ServicesPricing = (props) => {
  return (
    <div className="services-pricing-container">
      <Helmet>
        <title>Services-Pricing - Rose & Blush Beauty</title>
        <meta
          property="og:title"
          content="Services-Pricing - Rose &amp; Blush Beauty"
        />
      </Helmet>
      <div className="services-pricing-header">
        <header
          data-thq="thq-navbar"
          className="navbarContainer services-pricing-navbar-interactive"
        >
          <Link to="/" className="services-pricing-logo logo">
            rose &amp; blush beauty
          </Link>
          <div
            data-thq="thq-navbar-nav"
            className="services-pricing-desktop-menu"
          >
            <nav className="services-pricing-links">
              <Link to="/" className="services-pricing-nav12 bodySmall">
                Home
              </Link>
              <Link
                to="/services-pricing"
                className="services-pricing-nav22 bodySmall"
              >
                Services
              </Link>
              <Link
            ...
            <div className="services-pricing-buttons"></div>
          </div>
          <div
            data-thq="thq-burger-menu"
            className="services-pricing-burger-menu"
          >
            <svg
              viewBox="0 0 1024 1024"
              className="services-pricing-icon socialIcons"
            >
          ...
          <div
            ...
            className="services-pricing-mobile-menu1 mobileMenu"
          >
            <div className="services-pricing-nav">
              <div className="services-pricing-top">
                <span className="logo">GLAMOUR</span>
                <div
                  data-thq="thq-close-menu"
                  className="services-pricing-close-menu"
                >
                  <svg
                    viewBox="0 0 1024 1024"
                    className="services-pricing-icon02 socialIcons"
                  >
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="services-pricing-links1">
                <span className="services-pricing-nav121 bodySmall">Home</span>
                <span className="services-pricing-nav221 bodySmall">
                  Services
                </span>
                <span className="services-pricing-nav321 bodySmall">
                  Portfolio
                </span>
                <span className="services-pricing-nav421 bodySmall">
                  Book Now
                </span>
                <span className="services-pricing-nav521 bodySmall">
                  Contact
                </span>
              </nav>
              <div className="services-pricing-buttons1">
            ...
            <div>
              <svg
                ...
                className="services-pricing-icon04 socialIcons"
              >
              ...
              <svg
                ...
                className="services-pricing-icon06 socialIcons"
              >
              ...
              <svg
                ...
                className="services-pricing-icon08 socialIcons"
              >
      ...
      <div className="services-pricing-hero">
        <div id="Test" className="heroContainer services-pricing-hero1">
          <div className="services-pricing-container1">
            <h1 className="services-pricing-hero-heading heading1">
              Discover Your Beauty
            </h1>
            <span className="services-pricing-hero-sub-heading bodyLarge">
              <span>
                <span>
            ...
            <div className="services-pricing-btn-group">
      ...
      <div id="Services" className="services-pricing-features">
        <div className="featuresContainer">
          <div className="services-pricing-features1">
            <div className="services-pricing-container2">
              <span className="services-pricing-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
            ...
            <h1 className="services-pricing-text28 heading1">Portfolio</h1>
            <GalleryCard3 rootClassName="rootClassName12"></GalleryCard3>
            <GalleryCard3
      ...
      <div className="services-pricing-banner">
        <div className="bannerContainer services-pricing-banner1">
          <h1 className="services-pricing-banner-heading heading2">
            Welcome to the World of Makeup Magic
          </h1>
          <span className="services-pricing-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
      ...
      <div className="services-pricing-faq">
        <div className="faqContainer">
          <div className="services-pricing-faq1">
            <div className="services-pricing-container3">
              <span className="overline">
                <span>FAQ</span>
                <br></br>
              </span>
              <h2 className="services-pricing-text46 heading2">
                Common questions
              </h2>
              <span className="services-pricing-text47 bodyLarge">
                <span>
            ...
            <div className="services-pricing-container4">
              <Question1
      ...
      <div className="services-pricing-footer">
        <footer className="footerContainer services-pricing-footer1">
          <div className="services-pricing-container5">
            <span className="logo">rose &amp; blush beauty</span>
            <nav className="services-pricing-nav1">
              <span className="bodySmall">Home</span>
              <span className="services-pricing-nav222 bodySmall">
                Services
              </span>
              <span className="services-pricing-nav322 bodySmall">
                Portfolio
              </span>
              <span className="services-pricing-nav422 bodySmall">
                Book Now
              </span>
              <span className="services-pricing-nav522 bodySmall">Contact</span>
            </nav>
          </div>
          <div className="services-pricing-separator"></div>
          <div className="services-pricing-container6">
            <span className="bodySmall services-pricing-text50">
              © 2023 myCompany, All Rights Reserved.
            </span>
            <div className="services-pricing-icon-group1">
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="services-pricing-icon10 socialIcons"
              >
                <path d="M925.714 233.143c-25.143 36.571-56.571 69.143-92.571 95.429 0.571 8 0.571 16 0.571 24 0 244-185.714 525.143-525.143 525.143-104.571 0-201.714-30.286-283.429-82.857 14.857 1.714 29.143 2.286 44.571 2.286 86.286 0 165.714-29.143 229.143-78.857-81.143-1.714-149.143-54.857-172.571-128 11.429 1.714 22.857 2.857 34.857 2.857 16.571 0 33.143-2.286 48.571-6.286-84.571-17.143-148-91.429-148-181.143v-2.286c24.571 13.714 53.143 22.286 83.429 23.429-49.714-33.143-82.286-89.714-82.286-153.714 0-34.286 9.143-65.714 25.143-93.143 90.857 112 227.429 185.143 380.571 193.143-2.857-13.714-4.571-28-4.571-42.286 0-101.714 82.286-184.571 184.571-184.571 53.143 0 101.143 22.286 134.857 58.286 41.714-8 81.714-23.429 117.143-44.571-13.714 42.857-42.857 78.857-81.143 101.714 37.143-4 73.143-14.286 106.286-28.571z"></path>
              </svg>
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="services-pricing-icon12 socialIcons"
              >
                <path d="M585.143 512c0-80.571-65.714-146.286-146.286-146.286s-146.286 65.714-146.286 146.286 65.714 146.286 146.286 146.286 146.286-65.714 146.286-146.286zM664 512c0 124.571-100.571 225.143-225.143 225.143s-225.143-100.571-225.143-225.143 100.571-225.143 225.143-225.143 225.143 100.571 225.143 225.143zM725.714 277.714c0 29.143-23.429 52.571-52.571 52.571s-52.571-23.429-52.571-52.571 23.429-52.571 52.571-52.571 52.571 23.429 52.571 52.571zM438.857 152c-64 0-201.143-5.143-258.857 17.714-20 8-34.857 17.714-50.286 33.143s-25.143 30.286-33.143 50.286c-22.857 57.714-17.714 194.857-17.714 258.857s-5.143 201.143 17.714 258.857c8 20 17.714 34.857 33.143 50.286s30.286 25.143 50.286 33.143c57.714 22.857 194.857 17.714 258.857 17.714s201.143 5.143 258.857-17.714c20-8 34.857-17.714 50.286-33.143s25.143-30.286 33.143-50.286c22.857-57.714 17.714-194.857 17.714-258.857s5.143-201.143-17.714-258.857c-8-20-17.714-34.857-33.143-50.286s-30.286-25.143-50.286-33.143c-57.714-22.857-194.857-17.714-258.857-17.714zM877.714 512c0 60.571 0.571 120.571-2.857 181.143-3.429 70.286-19.429 132.571-70.857 184s-113.714 67.429-184 70.857c-60.571 3.429-120.571 2.857-181.143 2.857s-120.571 0.571-181.143-2.857c-70.286-3.429-132.571-19.429-184-70.857s-67.429-113.714-70.857-184c-3.429-60.571-2.857-120.571-2.857-181.143s-0.571-120.571 2.857-181.143c3.429-70.286 19.429-132.571 70.857-184s113.714-67.429 184-70.857c60.571-3.429 120.571-2.857 181.143-2.857s120.571-0.571 181.143 2.857c70.286 3.429 132.571 19.429 184 70.857s67.429 113.714 70.857 184c3.429 60.571 2.857 120.571 2.857 181.143z"></path>
              </svg>
              <svg
                viewBox="0 0 602.2582857142856 1024"
                className="services-pricing-icon14 socialIcons"
              >
                <path d="M548 6.857v150.857h-89.714c-70.286 0-83.429 33.714-83.429 82.286v108h167.429l-22.286 169.143h-145.143v433.714h-174.857v-433.714h-145.714v-169.143h145.714v-124.571c0-144.571 88.571-223.429 217.714-223.429 61.714 0 114.857 4.571 130.286 6.857z"></path>
              </svg>
            </div>
